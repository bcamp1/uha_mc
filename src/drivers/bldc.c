...
const BLDCConfig BLDC_CONF_CAPSTAN = {
	...
	.ident1_pin = PIN_BLDC_C_CONFIG1,
	.ident0_pin = PIN_BLDC_C_CONFIG2,
...
const BLDCConfig BLDC_CONF_TAKEUP = {
	...
	.ident1_pin = PIN_BLDC_A_CONFIG1,
	.ident0_pin = PIN_BLDC_A_CONFIG2,
...
const BLDCConfig BLDC_CONF_SUPPLY = {
	...
	.ident1_pin = PIN_BLDC_B_CONFIG1,
	.ident0_pin = PIN_BLDC_B_CONFIG2,
