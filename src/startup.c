...
void HardFault_Handler(void) {
    // You can use a breakpoint or just log the error

    
    // Optionally, you can implement code to dump register values, etc.
    // __asm("bkpt #0");  // This would trigger a breakpoint (debugging)
